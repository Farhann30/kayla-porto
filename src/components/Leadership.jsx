  ...
  return (
    <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto space-y-16">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <div className="flex bg-[#222] shadow-2xl rounded-sm overflow-hidden h-64 border border-gray-800">
             ...
             <div className="w-1/2">
               <img src="/images/kayla porto foto/HERO 10/HERO 10.1.png" alt="Uniform" className="w-full h-full object-cover" />
             </div>
          </div>
        </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-8 items-center pt-12 border-t border-gray-800">
        ...
        >
          <div className="w-48 md:w-56 h-[400px] md:h-[480px] border-[5px] border-gray-800 rounded-[2rem] md:rounded-[2.5rem] overflow-hidden flex-shrink-0 bg-black relative shadow-2xl">
            <img src="/images/kayla porto foto/HERO 10/HERO 10.2.png" className="w-full h-full object-cover" alt="PR Mockup" />
          </div>
          <div className="text-center mt-4">
             <a href="#" className="text-[#9d1010] font-serif font-bold text-sm underline">Click Here!</a>
          </div>
        </motion.div>
